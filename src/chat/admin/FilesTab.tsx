...
export function FilesTab() {
  ...
  // Auto-generated files (paste-as-file) are hidden by default; this toggle
  // reveals them. Not part of resetFilters on purpose: it is a VIEW preference,
  // not a data filter like the dropdowns.
  ...
  const data = useQuery(api.files.listMine, {
    ...
    includeAutoGenerated: showAutoGenerated || undefined,
  });
  ...
  return (
    <>
      ...
      >
        ...
        {/* Auto-generated files (paste-as-file) toggle — default OFF: the
            listing shows real files; flipping it reveals the generated ones. */}
        <label className="oc-files__autogen">
          <Checkbox
            checked={showAutoGenerated}
            onCheckedChange={(v) => setShowAutoGenerated(v === true)}
            aria-label={m.files_show_autogenerated()}
          />
          <span>{m.files_show_autogenerated()}</span>
        </label>
