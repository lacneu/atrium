// VENDORED VERBATIM from openclaw/openclaw @ v2026.9.6 — packages/gateway-protocol/src/validation-errors.ts.
...
import type { TypeBoxValidationError } from "./json-schema.js";
